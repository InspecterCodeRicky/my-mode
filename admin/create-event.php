<?php
   ...
   if(isset($_POST['title'], $_POST['content'], $_POST['address'], $_POST['date_depart'], $_POST['hour_depart'], $_POST['date_end'], $_POST['hour_end'])) {
     if(empty($_POST['title'])) {
       ...
       && $errorhour_end == false ) {
           $result = $article->create_event($title, $address,$status, $date_depart, $hour_depart, $date_end, $hour_end, $content, $email);
           if(isJSON($result)) {
                              ...
                              <form action="" method="post" enctype="multipart/form-data">
                                 <div class="row">
                                    <div class="col-12 mb-4">
                                       ...
                                       <input type="text" placeholder="Votre titre" class="form-control w-100 input_custom" id="title_annonce" name="title" value="<?php if((isset($_POST['title']))) { echo $_POST['title']; } ?>">
                                    </div>
                                    <div class="col-12 mb-4">
                                       ...
                                       <input type="text" placeholder="Adresse" class="form-control w-100 input_custom" id="address_event" name="address" value="<?php if((isset($_POST['address']))) { echo $_POST['address']; } ?>">
                                    </div>
                                    <div class="col-lg-6 col-md-12 mb-4">
                                       ...
                                       <input type="date" class="form-control w-100 input_custom" id="date_depart" name="date_depart" value="<?php if((isset($_POST['date_depart']))) { echo $_POST['date_depart']; } ?>">
                                    </div>
                                    <div class="col-lg-6 col-md-12 mb-4">
                                       ...
                                       <input type="time" class="form-control w-100 input_custom" id="hour_depart" name="hour_depart" value="<?php if((isset($_POST['hour_depart']))) { echo $_POST['hour_depart']; } ?>">
                                    </div>
                                    <div class="col-lg-6 col-md-12 mb-4">
                                       <label class="label" for="date_end">Date fin *</label>
                                       <?php if($errordate_end) ?> <small class="error  form-text"> <?= $errordate_end?> </small>
                                       <input type="date" class="form-control w-100 input_custom" id="date_end" name="date_end" value="<?php if((isset($_POST['date_end']))) { echo $_POST['date_end']; } ?>">
                                    </div>
                                    <div class="col-lg-6 col-md-12 mb-4">
                                       <label class="label" for="hour_end">Heure fin *</label>
                                       <?php if($errorhour_end) ?> <small class="error  form-text"> <?= $errorhour_end ?> </small>
                                       <input type="time" class="form-control w-100 input_custom" id="hour_end" name="hour_end" value="<?php if((isset($_POST['hour_end']))) { echo $_POST['hour_end']; } ?>">
                                    </div>
                                    <div class="col-12 mb-4">
