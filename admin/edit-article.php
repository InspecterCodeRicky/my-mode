<?php
   ...
   if(isset($_FILES['picture'], $_POST['title'], $_POST['content'])) {
     ...
     if(isset($_FILES['picture']['name']) && !empty($_FILES['picture']['name'])) {
       ...
       $old_targte_file = $editArticle['target_file'];
     } else {
       $target_file = $editArticle['target_file'];
     }
       ...
       if($errorImage == false && $errorTitle == false && $errorContent == false & $errorPostcheck == false & $errorTagname == false) {
           $result = $article->edit_article($id, $target_file, $title, $content, $tagname, $status, $author);
           if(isJSON($result)) {
             $error = json_decode($result);
             $error = $error->{"error"};
           }
           if($old_targte_file && $error == false) {
                  ...
                  <div class="content">
                     <div class="module">
                        <div class="module-head">
                           <h3 class="d-inline-block">Éditer votre article</h3>
                              ...
                              <div class="row">
                                 <form action="" method="post" enctype="multipart/form-data">
                                    <div class="col-12 mb-4">
                                       <div id="add_box_img" class="img-box bg-white">
                                          ...
                                          <div class="DropZone__Preview">
                                             <div id="img_Preview" class="DropZone__Preview--add" style="background-image : url(<?= $editArticle['target_file'] ?>); background-size : auto 100% ;">
                                    ...
                                    <div class="col-12 mb-4">
                                       ...
                                       <input type="text" placeholder="Votre titre" class="form-control w-100 input_custom" id="title_article" name="title" value="<?php if((isset($_POST['title'])) && !empty($_POST['title'])) { echo $_POST['title']; } else { echo $editArticle['title'] ;} ?>">
                                    </div>
                                    <div class="col-12 mb-4">
                                       ...
                                       <?php if((isset($_POST['content'])) && !empty($_POST['content'])) { echo $_POST['content']; }else { echo $editArticle['content'] ;}?>
                                       </textarea>
                                    </div>
                                    <div class="col-12 mb-4">
                                    ...
                                    <div class="col-12 mb-4">
                                       ...
                                       <input type="text" placeholder="Tagname" class="form-control w-100 input_custom" id="tags_article" name="Tagname" value="<?php if((isset($_POST['Tagname'])) && !empty($_POST['Tagname'])) { echo $_POST['Tagname']; } else { echo $editArticle['category'] ;}?>">
                                    </div>
                                    <div class="clearfix">
